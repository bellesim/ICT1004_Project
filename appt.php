                                ...
                                <tr> <td> <?php echo $row["ApptSubmitTime"]; ?> </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="flex flex-row-reverse">
                                            <div><button class="uk-button uk-button-medium uk-width-2-3 uk-width-auto@s rounded ml-24 text-red-100 transition-colors duration-150 bg-red-700" type="submit">Delete</button></div>
