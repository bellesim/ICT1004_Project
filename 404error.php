...
<section class="py-8 px-4 text-center">
    <div class="max-w-auto mx-auto">
        ...
        <h1 class="mt-8 uppercase text-xl lg:text-5xl font-black">We are sorry, Page not found!</h1>
    ...
    <a href="index.php" class="uk-button uk-button-primary uk-button-medium uk-width-2-3 mt-8 rounded ml-24 uk-width-auto@s ">Back To Homepage</a>
