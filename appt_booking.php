...
if (isset($_SESSION["NRIC"]) && isset($_SESSION["username"])) {
                                ...
                                <div class="container">
                                    ...
                                    <form action="appt_booked.php" method="post" class="form-control">
                                        ...
                                        <div class="uk-width-1-1 mb-8">
                                            <p class="text-base font-semibold mt-4 uk-form-label">Clinic: <?php echo $ClinicName; ?> </p>
                                        </div>
                                        <div class="uk-width-1-1 mb-8">
                                        ...
                                        <input type="hidden" id="ClinicID" name="ClinicID" value=" <?php echo $ClinicID; ?> "><br>
    ...
    <div class="space-y-6 text-black" style="margin: auto; width: 50%; ">
        ...
        <p class="uk-width-1-3 loginformbutton font-semibold"><a href="login.php">Login</a></p>
    </div>    
    <?php
}
?>
